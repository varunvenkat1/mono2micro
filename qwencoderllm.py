...
- Include each class and test classes with a class key under a single microservice only
...
- Do not provide any extra information and to microservice name don't append microservice and provide name key for microservice.
